...
public class UpwardBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    private boolean scrolling = true;

    public UpwardBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void tranY(View view, int y) {
        ...
        anim.setDuration(280).translationY(y);
